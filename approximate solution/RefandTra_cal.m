function Rj= RefandTra_cal(a1,a2,c_U,c_L,A_1,A_2,Nij,vs1,vs2)

%Step1 Calculate the slowness of incident wave    
 V_inc = phasepv(A_1,Nij,vs1,a1);
...
Pju =Polar_Sign_cal(Ml,Pl); %upper
